 ...
 * controller.
 */
enum PM_RESET_STATUS {
	/*
	 * Indicates that the last reset was caused by the
	 * POR (Reset because of power on/off or SOC) or Host reset i.e.
	 * Secure Enclave.
	 */
	PM_RESET_STATUS_POR_OR_SOC_OR_HOST_RESET = (1U << 0),
	/*
	 * Indicates that the last reset was caused by nSRST
	 */
	PM_RESET_STATUS_NSRST_RESET              = (1U << 1),
	/*
	 * Indicates that the last reset was caused by a
	 * request to reset this External System
	 */
	PM_RESET_STATUS_EXTERNAL_SYS_RESET       = (1U << 4),
 ...
 *           states to be entered if all subsystems have configured this,
 *           and they enter sleep. So this call can lead to overall SoC sleep.
 *
 * @note     This function should be called with interrupts disabled.
 ...
 * @return   None
 */
void pm_handle_spurious_wakeup(void);
#endif
