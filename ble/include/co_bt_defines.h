...
//byte7
#define BLE_RD_CON_ACCEPT_TO_CMD    0x04
#define BLE_WR_CON_ACCEPT_TO_CMD    0x08
//byte10
...
//byte13
#define BLE_RD_AFH_CH_ASSESS_MODE_CMD 0x04
#define BLE_WR_AFH_CH_ASSESS_MODE_CMD 0x08
//byte14
...
#define BLE_LE_SET_EXT_ADV_PARAM_V1_CMD         0x04
...
#define BLE_LE_SET_PER_ADV_PARAM_CMD            0x00 // Not supported
#define BLE_LE_SET_PER_ADV_DATA_CMD             0x00 // Not supported
#define BLE_LE_SET_PER_ADV_EN_CMD               0x00 // Not supported
...
#else // !defined (CFG_PER_ADV)
#define BLE_LE_PER_ADV_CREATE_SYNC_CMD          0x00 // Not supported
#define BLE_LE_PER_ADV_CREATE_SYNC_CANCEL_CMD   0x00 // Not supported
#define BLE_LE_PER_ADV_TERM_SYNC_CMD            0x00 // Not supported
#define BLE_LE_ADD_DEV_TO_PER_ADV_LIST_CMD      0x00 // Not supported
#define BLE_LE_RMV_DEV_FROM_PER_ADV_LIST_CMD    0x00 // Not supported
#define BLE_LE_CLEAR_PER_ADV_LIST_CMD           0x00 // Not supported
#define BLE_LE_RD_PER_ADV_LIST_SIZE_CMD         0x00 // Not supported
#endif // defined (CFG_PER_ADV)
...
#define BLE_LE_SET_CONLESS_CTE_TX_PARAM_CMD     0x00 // Not supported
#define BLE_LE_SET_CONLESS_CTE_TX_EN_CMD        0x00 // Not supported
...
#define BLE_LE_SET_CONLESS_IQ_SAMPL_EN_CMD      0x00 // Not supported
...
#define BLE_LE_SET_CON_CTE_RX_PARAM_CMD         0x00 // Not supported
...
#define BLE_LE_SET_CON_CTE_TX_PARAM_CMD         0x00 // Not supported
#endif // !defined (CFG_CON_CTE_RSP)
#if defined (CFG_CON_CTE_REQ)
#define BLE_LE_CON_CTE_REQ_EN_CMD               0x04
#else // !defined (CFG_CON_CTE_REQ)
#define BLE_LE_CON_CTE_REQ_EN_CMD               0x00 // Not supported
#endif // !defined (CFG_CON_CTE_REQ)
#if defined (CFG_CON_CTE_RSP)
#define BLE_LE_CON_CTE_RSP_EN_CMD               0x08
#else // !defined (CFG_CON_CTE_RSP)
#define BLE_LE_CON_CTE_RSP_EN_CMD               0x00 // Not supported
#endif // !defined (CFG_CON_CTE_RSP)
#if (defined(CFG_AOD) || defined(CFG_AOA))
#define BLE_LE_RD_ANTENNA_INF_CMD               0x10
#else // !(defined(CFG_AOD) || defined(CFG_AOA))
#define BLE_LE_RD_ANTENNA_INF_CMD               0x00 // Not supported
#endif // !(defined(CFG_AOD) || defined(CFG_AOA))
#if defined (CFG_PER_ADV)
#define BLE_LE_SET_PER_ADV_RX_EN_CMD            0x20
#else // !defined (CFG_PER_ADV)
#define BLE_LE_SET_PER_ADV_RX_EN_CMD            0x00 // Not supported
#endif // defined (CFG_PER_ADV)
#if defined (CFG_PAST)
...
enum le_phy_value
{
    ...
    PHY_2MBPS_VALUE    = 2,
    PHY_CODED_VALUE    = 3,
    #if (defined(CFG_LE_PWR_CTRL) || 0)
    PHY_CODED_S2_VALUE = 4,
    #endif // (defined(CFG_LE_PWR_CTRL) || 0)
};
