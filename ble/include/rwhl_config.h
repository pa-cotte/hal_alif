...
#if (BLE_BIS && BLE_PER_ADV)
#define GAPI_BROADCAST_SUPP          (BLE_GAPI)
#if (BLE_OBSERVER)
#define GAPI_BROADCAST_SINK_SUPP     (BLE_GAPI)
#else
#define GAPI_BROADCAST_SINK_SUPP     (0)
#endif //(BLE_OBSERVER)
#if (BLE_BROADCASTER)
#define GAPI_BROADCAST_SOURCE_SUPP   (BLE_GAPI)
#else
#define GAPI_BROADCAST_SOURCE_SUPP   (0)
#endif //(BLE_OBSERVER)
#else //(BLE_BIS && BLE_PER_ADV)
#define GAPI_BROADCAST_SUPP          (0)
#define GAPI_BROADCAST_SOURCE_SUPP   (0)
#define GAPI_BROADCAST_SINK_SUPP     (0)
#endif //(BLE_BIS && BLE_PER_ADV)
