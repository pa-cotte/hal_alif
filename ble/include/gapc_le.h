...
typedef struct gapc_le_subrate
{
    /// Subrate factor\n
...
/*@TRACE*/
typedef struct gapc_le_preferred_periph_param
{
...
typedef struct gapc_le_tx_power_report
{
...
typedef struct gapc_le_iq_report_info
{
...
typedef struct gapc_le_connection_param
{
    /// Connection interval minimum
    uint16_t intv_min;
    /// Connection interval maximum
...
/// VS LE Set Tx Power
typedef struct gapc_le_set_tx_power
{
    /// TX power (in dBm)
    int8_t tx_pwr;
