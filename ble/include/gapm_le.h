...
{
    /// Generic Unknown
    GAPM_LE_APPEARANCE_GENERIC_UNKNOWN = 0,
};
...
/*@TRACE*/
typedef struct gapm_le_init_con_param
{
...
typedef struct gapm_le_adv_report_info
{
...
/*@TRACE*/
typedef struct gapm_le_scan_wd_op_param
{
...
typedef struct gapm_le_iq_report_info
{
    /// Data channel index
    uint8_t channel_idx;
    /// RSSI (in 0.1 dBm)
...
typedef struct gapm_le_antenna_info
{
...
typedef struct gapm_le_suggested_default_data_len
{
...
typedef struct gapm_le_max_data_len
{
...
typedef struct gapm_le_tx_power_range
{
    /// Minimum TX power
    int8_t min_tx_pwr;
    /// Maximum TX power
...
typedef struct gapm_le_rf_path_compensation
{
...
/*@TRACE*/
typedef struct gapm_le_per_adv_bdaddr
{
...
typedef struct gapm_le_cb_actv
{
 ...
 ***************************************************************************************
 */
typedef void (*gapm_le_suggested_default_data_len_cb)(uint32_t metainfo, uint16_t status, const gapm_le_suggested_default_data_len_t *p_info);
 ...
 ***************************************************************************************
 */
typedef void (*gapm_le_max_data_len_cb)(uint32_t metainfo, uint16_t status, const gapm_le_max_data_len_t *p_info);
 ...
 ***************************************************************************************
 */
typedef void (*gapm_le_rf_path_compensation_cb)(uint32_t metainfo, uint16_t status, const gapm_le_rf_path_compensation_t* p_rf_path_comp);
 ...
 ***************************************************************************************
 */
uint16_t gapm_le_set_default_subrate(uint32_t metainfo, const gap_le_subrate_req_t* p_subrate_req, gapm_proc_cmp_cb cmp_cb);
#endif //(BT_53)
