...
/*@TRACE*/
struct hci_le_ext_create_con_v1_cmd
{
    ///Initiator filter policy
...
/// HCI basic command complete event structure with connection handle
/*@TRACE*/
struct hci_basic_conhdl_le_cmp_evt
{
    ///LE Subevent code
    uint8_t     subcode;
    /// status
...
/*@TRACE*/
struct hci_basic_adv_hdl_cmd_cmp_evt
{
    /// Status
    uint8_t     status;
    /// Advertising handle
...
/*@TRACE*/
struct hci_basic_sync_hdl_cmd_cmp_evt
{
    /// Status
    uint8_t     status;
    /// Sync handle
...
/*@TRACE*/
struct hci_le_per_adv_report_v1_evt
{
    ///LE Subevent code
    uint8_t             subcode;
    /// Sync Handle to be used
...
/// HCI command strucutre for the LE Transmit Power Reporting event
/*@TRACE*/
struct hci_dbg_le_set_rsp_tx_pwr_cmd
{
    /// Connection handle
    uint16_t        conhdl;
    /// TX power
...
/*@TRACE*/
struct hci_vs_bt_set_rx_max_slot_cmd
{
...
/*@TRACE*/
struct hci_vs_set_sched_prio_cmd
{
...
/*@TRACE*/
struct hci_vs_le_set_infinite_test_cmd
{
...
/*@TRACE*/
struct hci_le_set_ext_adv_param_v1_cmd
{
    /// Advertising handle
    uint8_t adv_hdl;
...
/*@TRACE*/
struct hci_le_set_per_adv_param_v1_cmd
{
    /// Advertising handle
    uint8_t adv_hdl;
...
struct hci_vs_le_set_tx_pwr_cmd
{
    /// Connection handle
    uint16_t con_hdl;
    /// TX power (in dBm)
...
/*@TRACE*/
struct hci_vs_le_set_tx_pwr_cmd_cmp_evt
{
    ///Status for command reception
    uint8_t status;
    /// TX power (in dBm)
...
/// It can also be used to configure a codec for each data path.
struct hci_vs_bt_setup_audio_data_path_cmd
{
    /// Connection handle
    uint16_t conhdl;
    /// Data path direction
...
/*@TRACE*/
struct hci_vs_bt_remove_audio_data_path_cmd
{
    /// Connection handle
    uint16_t conhdl;
    /// Data path direction
