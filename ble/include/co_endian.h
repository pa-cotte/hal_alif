 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void co_bswap_copy(uint8_t* p_val_out, const uint8_t* p_val_in, uint16_t len)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void co_bswap(uint8_t* p_val, uint16_t len)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_bswap32(uint32_t val32)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_bswap24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint16_t co_bswap16(uint16_t val16)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_htobe32(uint32_t hostlong)
{
    #if (!CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_htobe24(uint32_t host24)
{
    #if (!CPU_LE)
        return host24;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint16_t co_htobe16(uint16_t hostshort)
{
    #if (!CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_betoh32(uint32_t netlong)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_betoh24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint16_t co_betoh16(uint16_t netshort)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_htole24(uint32_t val24)
{
    #if (CPU_LE)
        return val24;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_htole32(uint32_t hostlong)
{
    #if (CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint16_t co_htole16(uint16_t hostshort)
{
    #if (CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_letoh24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint32_t co_letoh32(uint32_t btlong)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE uint16_t co_letoh16(uint16_t btshort)
{
