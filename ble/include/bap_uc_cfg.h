...
#define BAP_UC_CFG_32_1_gs          { .pres_delay_us = 21500,                   \
                                      .sdu_intv_us = 7500,                      \
                                      .samp_freq = BAP_SAMPLING_FREQ_32000HZ,   \
                                      .framing = ISO_UNFRAMED_MODE,             \
                                      .max_sdu_size = 60,                       \
...
#define BAP_UC_CFG_32_2_gs          { .pres_delay_us = 22500,                   \
                                      .sdu_intv_us = 10000,                     \
                                      .samp_freq = BAP_SAMPLING_FREQ_32000HZ,   \
                                      .framing = ISO_UNFRAMED_MODE,             \
                                      .max_sdu_size = 80,                       \
...
#define BAP_UC_CFG_48_1_gs          { .pres_delay_us = 21500,                   \
                                      .sdu_intv_us = 7500,                      \
                                      .samp_freq = BAP_SAMPLING_FREQ_48000HZ,   \
                                      .framing = ISO_UNFRAMED_MODE,             \
                                      .max_sdu_size = 75,                       \
...
#define BAP_UC_CFG_48_2_gs          { .pres_delay_us = 22500,                   \
                                      .sdu_intv_us = 10000,                     \
                                      .samp_freq = BAP_SAMPLING_FREQ_48000HZ,   \
                                      .framing = ISO_UNFRAMED_MODE,             \
                                      .max_sdu_size = 100,                      \
