...
/**
 ****************************************************************************************
 * @brief Process all kernel events before returning to main loop.
 *
 * This primitive or #ke_event_process_single must be called by main loop in order to
 * execute background process.
 ****************************************************************************************
 */
void ke_event_process(void);

/**
 ****************************************************************************************
 * @brief Process a single kernel events before returning to main loop.
 *
 * This primitive or #ke_event_process must be called by main loop in order to execute
 * background process.
 ****************************************************************************************
 */
void ke_event_process_single(void);
