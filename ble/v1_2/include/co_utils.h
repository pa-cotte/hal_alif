...
#if (BLE_CHSD)
/// Convert PHY CHSD mask (with one single bit set) to a value
extern const uint8_t co_phy_chsd_mask_to_value[];

/// Convert PHY CHSD value to the corresponding mask bit
extern const uint8_t co_phy_chsd_value_to_mask[];
#endif // (BLE_CHSD)
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE int8_t co_find_val(const uint8_t val, const uint8_t* p_vals, uint8_t len)
{
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void co_util_clk_shift(rwip_time_t* clock, int32_t shift)
{
    shift += clock->hus;
 ...
 ****************************************************************************************
 */
__STATIC_FORCEINLINE void co_util_clk_shift_forward(rwip_time_t* clock, uint32_t shift)
{
    uint16_t num_hs;
    shift += clock->hus;
