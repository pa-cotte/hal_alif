...
/**
 ****************************************************************************************
 * @defgroup GATT_API Generic Attribute Profile (GATT)
 * @brief  The GATT module is responsible for service and client attribute protocol handling
 *
 * @defgroup GATT_COMMON_API Common
 * @ingroup GATT_API
 * @brief Common Types, enumerations and functions API
 *
 * @defgroup GATT_COMMON_DEFINE_API Defines / Macros
 * @ingroup GATT_COMMON_API
 *
 * @defgroup GATT_COMMON_ENUM_API Enumerations
 * @ingroup GATT_COMMON_API
 *
 * @defgroup GATT_COMMON_TYPE_API Types definitions
 * @ingroup GATT_COMMON_API
 *
 * @defgroup GATT_COMMON_UTILS_API Utilities
 * @ingroup GATT_COMMON_API
 *
 * @defgroup GATT_COMMON_USER_API User Management
 * @ingroup GATT_COMMON_API
 * @brief  The GATT module is responsible for service and client user registration
 ****************************************************************************************
 */
...
/// @addtogroup GATT_COMMON_DEFINE_API
/// @{

/// Helper to define an attribute property
/// @param prop Property see #gatt_prop_bf enumeration
...
/// @addtogroup GATT_COMMON_USER_API
/// @{
...
/// @} GATT_COMMON_USER_API

/// @addtogroup GATT_COMMON_ENUM_API
/// @{
...
enum gatt_char
{
    ...
    GATT_SVC_PUBLIC_BROADCAST_ANNOUNCEMENT = GATT_UUID_16_LSB(0x1856), //!< Value: 0x1856

    /// Electronic Shelf Label Service UUID
    GATT_SVC_ELECTRONIC_SHELF_LABEL = GATT_UUID_16_LSB(0x1857), //!< Value: 0x1857
    /// Ranging Service UUID
    GATT_SVC_RANGING = GATT_UUID_16_LSB(0xFFE0u), //!< Value: 0xFFE0
    ...
    GATT_CHAR_BOND_MANAGEMENT_CP = GATT_UUID_16_LSB(0x2AA4), //!< Value: 0x2AA4
    /// Bond Manamagement Features
    GATT_CHAR_BOND_MANAGEMENT_FEATURES = GATT_UUID_16_LSB(0x2AA5), //!< Value: 0x2AA5
    ...
    GATT_CHAR_GMAS_ROLE = GATT_UUID_16_LSB(0x2BDD), //!< Value: 0x2BDD
    /// Gaming Audio Service - UGG Features characteristic
    GATT_CHAR_GMAS_UGG_FEATURES = GATT_UUID_16_LSB(0x2BDE), //!< Value: 0x2BDE
    /// Gaming Audio Service - UGT Features characteristic
    GATT_CHAR_GMAS_UGT_FEATURES = GATT_UUID_16_LSB(0x2BDF), //!< Value: 0x2BDF
    /// Gaming Audio Service - BGS Features characteristic
    GATT_CHAR_GMAS_BGS_FEATURES = GATT_UUID_16_LSB(0x2BE0), //!< Value: 0x2BE0
    /// Gaming Audio Service - BGR Features characteristic
    GATT_CHAR_GMAS_BGR_FEATURES = GATT_UUID_16_LSB(0x2BE1), //!< Value: 0x2BE1

    /// ESL Service - ESL Address characteristic
    GATT_CHAR_ESL_ADDRESS = GATT_UUID_16_LSB(0x2BF6u), // !< Value: 0x2BF6
    /// ESL Service - ESL AP sync key material characteristic
    GATT_CHAR_ESL_AP_SYNC_KEY = GATT_UUID_16_LSB(0x2BF7u), // !< Value: 0x2BF7
    /// ESL Service - ESL Response key material characteristic
    GATT_CHAR_ESL_RESPONSE_KEY = GATT_UUID_16_LSB(0x2BF8u), // !< Value: 0x2BF8
    /// ESL Service - ESL Current absolute time characteristic
    GATT_CHAR_ESL_ABSOLUTE_TIME = GATT_UUID_16_LSB(0x2BF9u), // !< Value: 0x2BF9
    /// ESL Service - ESL Display information characteristic
    GATT_CHAR_ESL_DISPLAY_INFO = GATT_UUID_16_LSB(0x2BFAu), // !< Value: 0x2BFA
    /// ESL Service - ESL Image information characteristic
    GATT_CHAR_ESL_IMAGE_INFO = GATT_UUID_16_LSB(0x2BFBu), // !< Value: 0x2BFB
    /// ESL Service - ESL Sensor information characteristic
    GATT_CHAR_ESL_SENSOR_INFO = GATT_UUID_16_LSB(0x2BFCu), // !< Value: 0x2BFC
    /// ESL Service - ESL LED information characteristic
    ...
    /// Ranging Service - Real-time Ranging Data characteristic
    GATT_CHAR_RAS_REAL_TIME = GATT_UUID_16_LSB(0xFFF1u), // !< Value: 0xFFF1
    /// Ranging Service - On-demand Ranging Data characteristic
    GATT_CHAR_RAS_ON_DEMAND = GATT_UUID_16_LSB(0xFFF2u), // !< Value: 0xFFF2
    /// Ranging Service - RAS Control Point characteristic
    GATT_CHAR_RAS_CP = GATT_UUID_16_LSB(0xFFF3u), // !< Value: 0xFFF3
    /// Ranging Service - Ranging Data Ready characteristic
    GATT_CHAR_RAS_DATA_READY = GATT_UUID_16_LSB(0xFFF4u), // !< Value: 0xFFF4
    /// Ranging Service - Ranging Data Overwritten characteristic
    GATT_CHAR_RAS_DATA_OVERWRITTEN = GATT_UUID_16_LSB(0xFFF5u), // !< Value: 0xFFF5
...
/// @} GATT_COMMON_ENUM_API
/*
 * STRUCTURES
 ************************************************************************************
 */

/// @addtogroup GATT_COMMON_TYPE_API
/// @{
...
/// @} GATT_COMMON_TYPE_API

typedef struct gatt_srv_cb gatt_srv_cb_t;
typedef struct gatt_cli_cb gatt_cli_cb_t;
...
/// @addtogroup GATT_COMMON_UTILS_API
/// @{
 ...
 * @param[in]  uuid_a_type  UUID A type (see #gatt_uuid_type enumeration)
 * @param[in]  p_uuid_b     UUID B value
 * @param[in]  uuid_b_type  UUID B type (see #gatt_uuid_type enumeration)
 *
 ...
 * @param[out] p_out_uuid_type   Output UUID type (see #gatt_uuid_type enumeration)
 ...
 */
uint16_t gatt_uuid_extract(uint8_t *p_out_uuid, uint8_t* p_out_uuid_type, const uint8_t *p_in_uuid,
                           uint8_t in_uuid_len);
...
/// @} GATT_COMMON_UTILS_API

/*
 * USER REGISTRATION API - FUNCTIONS DEFINITIONS
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Function used to register a GATT user. This must be done prior to any GATT
 *        procedure execution.
 *
