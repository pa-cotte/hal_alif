...
/// Set new IRK
/*@TRACE*/
typedef struct gapm_le_set_irk_cmd
{
...
/*@TRACE*/
typedef struct gapm_le_set_channel_map_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_configure_security_level_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_adv_tx_power_ind
{
...
/*@TRACE*/
typedef struct gapm_le_antenna_info_ind
{
...
/*@TRACE*/
typedef struct gapm_le_ral_addr_ind
{
    /// Requested operation type (see #gapm_operation enumeration)
    uint8_t operation;
...
/*@TRACE*/
typedef struct gapm_le_resolve_addr_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_addr_resolved_ind
{
...
/*@TRACE*/
typedef struct gapm_le_generate_random_addr_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_use_encryption_block_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_encryption_result_ind
{
    /// Result (16 bytes)
...
/*@TRACE*/
typedef struct gapm_le_compute_dh_key_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_dh_key_ind
{
    /// Result (32 bytes)
...
/*@TRACE*/
typedef struct gapm_le_get_public_key_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_public_key_ind
{
    /// X coordinate
...
/*@TRACE*/
typedef struct gapm_le_oob_data_ind
{
    /// Generated OOB data
    gap_oob_t oob;
...
/*@TRACE*/
typedef struct gapm_le_generate_random_nb_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_random_nb_ind
{
...
/*@TRACE*/
typedef struct gapm_le_suggested_default_data_len_ind
{
...
/*@TRACE*/
typedef struct gapm_le_max_data_len_ind
{
...
typedef struct gapm_le_control_test_mode
{
    /// Requested operation type (see #gapm_operation enumeration)
...
typedef struct gapm_le_test_end_ind
{
...
/*@TRACE*/
typedef struct gapm_le_test_iq_report_ind
{
    /// Data channel index
    uint8_t channel_idx;
    /// RSSI (in 0.1 dBm)
...
/*@TRACE*/
typedef struct gapm_le_activity_create_adv_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_set_adv_data_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
    ///  - #GAPM_LE_SET_ADV_DATA: Set advertising data
    ///  - #GAPM_LE_FORCE_ADV_DATA: Force advertising data
...
/*@TRACE*/
typedef struct gapm_le_scan_request_ind
{
    /// Activity identifier
    uint8_t actv_idx;
...
/*@TRACE*/
typedef struct gapm_le_adv_report_ind
{
    /// Activity identifier
    uint8_t actv_idx;
...
/*@TRACE*/
typedef struct gapm_le_big_info_ind
{
    /// Activity identifier
    uint8_t actv_idx;
    /// Big Info report
...
/*@TRACE*/
typedef struct gapm_le_per_sync_established_ind
{
    /// Activity identifier
    uint8_t actv_idx;
...
/*@TRACE*/
typedef struct gapm_le_get_ral_addr_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
typedef struct gapm_le_fill_list_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_fill_fal_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
    ///  - #GAPM_LE_FILL_FAL: Set filter accept list content
    uint8_t operation;
...
/*@TRACE*/
typedef struct gapm_le_fill_ral_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
    ///  - #GAPM_LE_FILL_RAL: Set resolving list content
    uint8_t operation;
...
/*@TRACE*/
typedef struct gapm_le_fill_pal_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
    ///  - #GAPM_LE_FILL_PAL: Set periodic advertiser list content
    uint8_t operation;
...
/*@TRACE*/
typedef struct gapm_le_list_size_ind
{
    /// Requested operation type (see #gapm_operation enumeration)
    ///     - #GAPM_LE_FILL_FAL
    ///     - #GAPM_LE_FILL_RAL
...
/*@TRACE*/
typedef struct gapm_le_max_adv_data_len_ind
{
...
/*@TRACE*/
typedef struct gapm_le_nb_adv_sets_ind
{
...
/*@TRACE*/
typedef struct gapm_le_tx_power_ind
{
    /// Minimum TX power
    int8_t min_tx_pwr;
    /// Maximum TX power
...
/*@TRACE*/
typedef struct gapm_le_rf_path_compensation_ind
{
...
/*@TRACE*/
typedef struct gapm_le_control_per_sync_report_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_control_per_sync_iq_sampling_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_per_adv_iq_report_ind
{
    /// Activity identifier
    uint8_t actv_idx;
    /// Data channel index
...
/*@TRACE*/
typedef struct gapm_le_control_per_adv_cte_tx_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_dbg_configure_iqgen_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_control_ch_scan_cmd
{
...
typedef struct gapm_le_init_start_param
{
...
/*@TRACE*/
typedef struct gapm_le_activity_start_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_set_adv_addr_change_reasons_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
...
/*@TRACE*/
typedef struct gapm_le_set_default_subrate_cmd
{
    /// Requested operation type (see #gapm_operation enumeration)
