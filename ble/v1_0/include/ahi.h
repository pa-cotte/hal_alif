...
/// MAC154App reset command (LC + KE_HEADER + command code + dummy)
#define AHI_RESET_MSG_LEN    (1+AHI_KE_MSG_HDR_LEN+2+2)
...
/**
 ****************************************************************************************
 * @brief Event sent over AHI uart when communication is out of sync
 ****************************************************************************************
 */
void ahi_send_out_of_sync_evt(void);
