 ...
 ****************************************************************************************
 */
uint16_t gatt_cli_discover_desc(uint8_t conidx, uint8_t user_lid, uint16_t metainfo, uint16_t start_hdl, uint16_t end_hdl);
 ...
 ****************************************************************************************
 */
uint16_t gatt_cli_write_reliable(uint8_t conidx, uint8_t user_lid, uint16_t metainfo, uint8_t write_type, uint8_t write_mode,
                                 uint16_t hdl, uint16_t offset, uint16_t length);
