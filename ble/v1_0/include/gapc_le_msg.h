...
/*@TRACE*/
typedef struct gapc_le_connection_req_ind
{
    /// Connection index
    uint8_t conidx;
    /// Connection handle
...
/*@TRACE*/
typedef struct gapc_le_peer_features_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_channel_map_ind
{
    /// Connection index
    uint8_t conidx;
    /// channel map value
...
/*@TRACE*/
typedef struct gapc_le_update_params_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_update_params_req_ind
{
    /// Connection index
    uint8_t conidx;
    /// Connection interval minimum
...
/*@TRACE*/
typedef struct gapc_le_params_updated_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_update_params_cfm
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_set_preferred_periph_latency_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_set_preferred_periph_event_duration_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_set_max_rx_size_and_time_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_start_past_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_configure_cte_tx_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_configure_cte_rx_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_control_cte_request_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_control_cte_response_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_cte_iq_report_ind
{
    /// Connection index
    uint8_t conidx;
...
typedef struct gapc_le_cte_request_failed_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_set_packet_size_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_packet_size_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_set_phy_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_phy_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_channel_selection_algo_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_local_tx_power_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_peer_tx_power_ind
{
    /// Connection index
    uint8_t conidx;
    /// PHY (see #gapc_phy_pwr_value enumeration)
...
/*@TRACE*/
typedef struct gapc_le_control_tx_power_report_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_local_tx_power_report_ind
{
    /// Connection index
    uint8_t conidx;
    /// PHY (see #gapc_phy_pwr_value enumeration)
...
/*@TRACE*/
typedef struct gapc_le_peer_tx_power_report_ind
{
    /// Connection index
    uint8_t conidx;
    /// PHY (see #gapc_phy_pwr_value enumeration)
...
/*@TRACE*/
typedef struct gapc_le_control_path_loss_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_path_loss_threshold_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_encrypt_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_encrypt_req_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_encrypt_cfm
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_request_security_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_security_ind
{
    /// Connection index
    uint8_t conidx;
...
/*@TRACE*/
typedef struct gapc_le_notify_key_pressed_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
/*@TRACE*/
typedef struct gapc_le_key_pressed_ind
{
    /// Connection index
    uint8_t conidx;
    /// notification type
...
/*@TRACE*/
typedef struct gapc_le_bond_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
typedef struct gapc_le_update_subrate_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
typedef struct gapc_le_subrate_ind
{
    /// Connection index
    uint8_t conidx;
...
typedef struct gapc_le_set_tx_power_cmd
{
    /// Connection index
    uint8_t conidx;
    /// GAP request type:
...
typedef struct gapc_le_set_tx_power_ind
{
    /// Connection index
    uint8_t conidx;
    /// TX power (in dBm)
